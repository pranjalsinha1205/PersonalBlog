package com.personalblogging.PersonalBlog.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> handleAuthenticationException(AuthenticationException ex, WebRequest request) {
        List<String> errors = Collections.singletonList(ex.getMessage());
