...
public class JwtHelper {
    ...
    public static final long JWT_TOKEN_VALIDITY = 124 * 60 * 60;
    ...
    public String generateToken(UserDetails userDetails, User user, Role role) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userId",user.getId());
        claims.put("roleType", role.getRole());
